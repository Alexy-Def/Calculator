...
showmessage('Для начала введите число для вычисления.');
end;
...
a:=strtofloat(panel2.Caption);
c:=sqrt(a);
panel1.Caption:='Кв.кор.из '+floattostr(a)+' = '+floattostr(c);
end
else
showmessage('Для начала введите число для вычисления.');
end;
...
else showmessage('Для начала введите число для вычисления.');
end;
...
begin
form2.label1.caption:='Данный инструмент - "Калькулятор"'#13'представляет собой генератор'#13'вычислений. Калькулятор достаточно'#13'простой, но многофункциональный.'#13'Ощутите все его возможности.';
form2.show;
end;

procedure TForm1.N2Click(Sender: TObject);
begin
Form3.Label1.Caption:='Данную работу выполнила сия дама -'#13'Тевризова Виктория Игоревна.'#13'Студентка 1 курса факультета МОС.'#13'Дата рождения: 25.01.1999 года.'#13'Что еще сказать, даже не знаю'#13'Увидимся позже, до новых встреч!';
form3.show
end;
